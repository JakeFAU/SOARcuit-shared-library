...
class SOARcuitBaseSettings(BaseSettings):
    ...
    environment: str = Field(
        ...
        validation_alias=AliasChoices(
            "environment",
            "ENVIRONMENT",
            "THALAMUS_ENVIRONMENT",
            "HIPPOCAMPUS_ENVIRONMENT",
            "CORTEX_ENVIRONMENT",
        ),
    )
    google_genai_key: SecretStr = Field(
        ...
        validation_alias=AliasChoices(
            ...
            "HIPPOCAMPUS_GOOGLE_GENAI_KEY",
            "CORTEX_GOOGLE_GENAI_KEY",
            "GOOGLE_API_KEY",
            "THALAMUS_GOOGLE_API_KEY",
            "HIPPOCAMPUS_GOOGLE_API_KEY",
